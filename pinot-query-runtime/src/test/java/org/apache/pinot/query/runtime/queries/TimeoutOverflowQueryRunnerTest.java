...
public class TimeoutOverflowQueryRunnerTest extends QueryRunnerTestBase {
  ...
  public void setUp()
      throws Exception {
    SlowMockInstanceDataManagerFactory slowFactory = new SlowMockInstanceDataManagerFactory("slowServer", 200);
  ...
  public void testTimeoutOverflowBreakReturnsPartialResults() {
    String sql = "SET useMultistageEngine='true';SET timeoutOverflowMode='BREAK';SET timeoutMs='20';"
        + "SET extraPassiveTimeoutMs='0';SELECT col1 FROM " + TABLE_NAME + " LIMIT 5";
  ...
  public void testTimeoutOverflowThrowFailsQuery() {
    String sql = "SET useMultistageEngine='true';SET timeoutOverflowMode='THROW';SET timeoutMs='20';"
        + "SET extraPassiveTimeoutMs='0';SELECT col1 FROM " + TABLE_NAME + " LIMIT 5";
    QueryDispatcher.QueryResult result = queryRunner(sql, false);
  ...
  public void testTimeoutOverflowBreakOnJoin() {
    String sql = "SET useMultistageEngine='true';SET timeoutOverflowMode='BREAK';SET timeoutMs='20';"
        + "SET extraPassiveTimeoutMs='0';SELECT slow.col1, fast.col1 FROM " + TABLE_NAME + " slow JOIN "
  ...
  public void testTimeoutOverflowBreakOnAggregation() {
    String sql = "SET useMultistageEngine='true';SET timeoutOverflowMode='BREAK';SET timeoutMs='20';"
        + "SET extraPassiveTimeoutMs='0';SELECT col2, COUNT(*) FROM " + TABLE_NAME + " GROUP BY col2";
    QueryDispatcher.QueryResult result = queryRunner(sql, false);
