...
public class ForwardIndexType extends AbstractIndexType<ForwardIndexConfig, ForwardIndexReader, ForwardIndexCreator> {
  ...
  public ForwardIndexCreator createIndexCreator(IndexCreationContext context, ForwardIndexConfig indexConfig)
      throws Exception {
    // indexConfig is intentionally not forwarded: the forward index configuration is embedded in the context
    // (via IndexCreationContext.getForwardIndexConfig()), so ForwardIndexCreatorFactory reads it directly from there.
  ...
  public String getFileExtension(ColumnMetadata columnMetadata) {
    boolean isRawEncoded =
        columnMetadata.getForwardIndexEncoding() == IndexCreationContext.ForwardIndexEncoding.RAW;
