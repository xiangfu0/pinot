...
public class PinotAdminClientTest {
  ...
  public void testTaskEndpointsParseBareValues()
    ...
    assertEquals(taskClient.getTaskStates("TaskA"), Map.of("Task_TaskA_1", "COMPLETED"));
    assertEquals(taskClient.getTaskStatesByTable("TaskA", "tbl1_OFFLINE"), Map.of("Task_TaskA_1", "COMPLETED"));
