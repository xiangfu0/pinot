...
public class IndexingConfig extends BaseJsonConfig {
  ...
  private List<String> _timestampIndexColumns;
  ...
  public List<String> getTimestampIndexColumns() {
    return _timestampIndexColumns;
  }

  public void setTimestampIndexColumns(List<String> timestampIndexColumns) {
    _timestampIndexColumns = timestampIndexColumns;
  }
