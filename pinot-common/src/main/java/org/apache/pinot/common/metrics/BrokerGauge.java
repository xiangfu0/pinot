...
public enum BrokerGauge implements AbstractMetrics.Gauge {
  ...
  LAKEHOUSE_ROUTED_TABLET_COUNT("tablets", false),
  LAKEHOUSE_OPTIONAL_TABLET_COUNT("tablets", false),
  LAKEHOUSE_PRUNED_TABLET_COUNT("tablets", false),
  LAKEHOUSE_TABLET_PRUNING_PERCENT("percent", false),
