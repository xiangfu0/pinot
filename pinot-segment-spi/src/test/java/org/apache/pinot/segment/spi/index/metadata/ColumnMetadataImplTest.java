...
public class ColumnMetadataImplTest {
  ...
  public void fallsBackToDictionaryEncodingWhenKeyAbsentAndHasDictionary() {
    ...
    assertEquals(metadata.getForwardIndexEncoding(), IndexCreationContext.ForwardIndexEncoding.DICTIONARY,
  ...
  public void fallsBackToRawEncodingWhenKeyAbsentAndNoDictionary() {
    ...
    assertEquals(metadata.getForwardIndexEncoding(), IndexCreationContext.ForwardIndexEncoding.RAW,
  ...
  public void honorsExplicitRawEncodingEvenWhenHasDictionary() {
    PropertiesConfiguration config = baseConfig("col");
    config.setProperty(Column.getKeyFor("col", Column.HAS_DICTIONARY), true);
    config.setProperty(Column.getKeyFor("col", Column.FORWARD_INDEX_ENCODING),
  ...
  /**
   * Encoding name parsing is case-insensitive. {@link ColumnMetadataImpl#fromPropertiesConfiguration} uppercases
   * the value before {@code ForwardIndexEncoding.valueOf(...)} so lower-case values written by old/buggy producers
   * still load.
   */
  @Test
  public void parsesEncodingCaseInsensitively() {
    PropertiesConfiguration config = baseConfig("col");
    config.setProperty(Column.getKeyFor("col", Column.HAS_DICTIONARY), true);
    config.setProperty(Column.getKeyFor("col", Column.FORWARD_INDEX_ENCODING), "raw");
