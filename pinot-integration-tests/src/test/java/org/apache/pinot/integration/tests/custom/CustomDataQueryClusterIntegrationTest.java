...
public abstract class CustomDataQueryClusterIntegrationTest extends BaseClusterIntegrationTest {
   ...
   * (e.g. walk TableDataManager, acquire segments) must use this rather than {@code _serverStarters} on
   * {@code this}, because in suite mode only the shared instance has the populated list.
   */
