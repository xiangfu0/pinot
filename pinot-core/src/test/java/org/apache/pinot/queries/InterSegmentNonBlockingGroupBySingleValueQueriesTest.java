...
/**
 * Reuses the inter-segment group-by order-by coverage with the non-blocking combine operator enabled.
 */
public class InterSegmentNonBlockingGroupBySingleValueQueriesTest
  ...
  private static final Map<String, String> QUERY_OPTIONS = Map.of("groupByAlgorithm", "non-blocking");
