...
public class ColumnValueSegmentPrunerTest {
   ...
   * <ul>
   *   <li>A value that is within the min/max range AND maps to the segment's partition → keep (false)</li>
   *   <li>All values within the min/max range but NONE maps to the segment's partition → prune (true)</li>
   *   <li>All values outside the min/max range → prune (true) regardless of partition</li>
   * </ul>
   */
  @Test
